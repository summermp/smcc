...
function addressAutocomplete(containerElement, callback, options) {
  ...
  // var inputElement = document.getElementById("ubicacionCultivo");
  inputElement= document.createElement("input");
  inputElement.setAttribute("type", "text");
  inputElement.setAttribute("id", "ubicacion")
  inputElement.setAttribute("name", "direccion")
  inputElement.setAttribute("th:field", "*{direccion}")
  inputElement.setAttribute("autocomplete", "off")
  inputElement.setAttribute("class", "entrada-linea");
  ...
  inputElement.addEventListener("input", function (e) {
    ...
    var promise = new Promise((resolve, reject) => {
      ...
      var apiKey = "4c54f9141e0c405ba246a43ca1298ea1";
      var url = `https://api.geoapify.com/v1/geocode/autocomplete?text=${encodeURIComponent(
        currentValue
      )}&filter=countrycode:pe&lang=es&limit=5&apiKey=${apiKey}`;
      if (options.type) {
